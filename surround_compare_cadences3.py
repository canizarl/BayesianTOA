...
if __name__ == "__main__":
    ...
    experiment = {}
    dir_out = f"SURROUND_CADENCES_EXPERIMENT_{N_STATIONS}"
    mkdirectory(dir_out)
    fname =  f"{dir_out}/surround_cadence_experiment_NAdeg.pkl"
    ...
    if run_sim == True:
        ...
        t_report_loops.append([f'Angle: N/A',t_loop_end-t_loop_start])
    ...
    if run_plot == True:
        ...
        figname = f"frame_3SPACECRAFT.jpg"
